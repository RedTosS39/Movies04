...
// getting the recyclerview by its id
        ...
        //retrofit response
        val apiInterface = ApiInterface.create().getMovies("c5822a12fa740c5cd4ed818c615d0aac") //API KEY

        apiInterface.enqueue( object : Callback<Movies>, MovieAdapter.CustomAdapter.ItemClickListener {
